...
define(['angular', 'webuploader'],
    function (angular, WebUploader) {
        ...
        HB_FileUploaderDirective.$inject = ['HB_WebUploaderService', '$timeout', '$log', '$parse', '$rootScope', 'HB_WebUploader', 'HB_notification']

        function HB_FileUploaderDirective (HB_WebUploaderService, $timeout, $log, $parse, $rootScope, HB_WebUploader, HB_notification) {
            return {
                restrict: 'AE',
                require: '?^ngModel',
                scope: {
                ...
                link: function ($scope, $element, $attr, ngModelController) {
                    ...
                    HB_WU.on('fileQueued', function (file) {
                        ...
                        if (HB_WebUploaderService.superBigFileSize < file.size && isIe) {
                            HB_notification.alert('想体验超爽超大文件上传，请用chrome或者firefox主流浏览器....')
                            return false
                        }
                    ...
                    HB_WU.on('error', function (error) {
                        ...
                        switch (error) {
                            ...
                            case 'Q_EXCEED_SIZE_LIMIT':
                                HB_notification.alert('文件不能超过' + WebUploader.Base.formatSize($scope.sizeLimit))
                                break
                        }
